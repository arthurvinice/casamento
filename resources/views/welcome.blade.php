...
<html
  ...
  <head>
    ...
    <title>Giulia & Esdras</title>
      ...
      <meta property="og:description" content="Participe deste momento especial com Giulia & Esdras. Veja informações sobre a cerimônia, recepção e lista de presentes." />
    ...
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
      ...
      <style>
        ...
        .box {
            background: #f9d6d5; /* cor uniforme */
            padding: 20px 25px;
            border-radius: 15px;
            min-width: 100px;
            text-align: center;
        ...
        <div class="container">
            <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
                ...
                <div class="navbar-brand app-brand demo d-flex py-0 me-4 me-xl-8 ms-0">
                    ...
                    <a href="landing-page.html" class="app-brand-link text-decoration-none">
                ...
                <div class="collapse navbar-collapse landing-nav-menu" id="navbarSupportedContent">
                    ...
                    <!-- MUDANÇA AQUI: trocou me-auto por ms-auto -->
  ...
  <div data-bs-spy="scroll" class="scrollspy-example">
    ...
    <section style="height: 100vh;" id="hero-animation">
      <div id="landingHero" class="section-py landing-hero position-relative">
        <img src="../../assets/img/img-teste.jpg" alt="background" class="position-absolute top-0 start-50 translate-middle-x object-fit-cover w-100" data-speed="1" style="height: 100vh;"/>
        <div class="position-absolute top-30 start-50 translate-middle-x mt-5">
            <img src="../../assets/img/logo.png" alt="Logo G&E" class="img-fluid mb-1 pb-0" style="max-width: 250px;">
    ...
    <section id="landingFeatures" class="section-py landing-features" data-aos="fade-up">
      <div class="container">
        <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
            <h2 class="text-center text-primary h2 pb-3" id=""contagem"> CONTAGEM REGRESSIVA</h2>
            <div class="contador">
                <div class="box" id="dias"><span class="number">0</span><span class="label">dias</span></div>
                <div class="box" id="horas"><span class="number">0</span><span class="label">horas</span></div>
                <div class="box" id="minutos"><span class="number">0</span><span class="label">minutos</span></div>
                <div class="box" id="segundos"><span class="number">0</span><span class="label">segundos</span></div>
            </div>
  ...
  <div class="footer-bottom py-3 py-md-5">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      <div class="mb-2 mb-md-0">
        ...
        <span class="footer-bottom-text"> Made by <a href="https://www.linkedin.com/in/arthurfmacedo/" target="_blank" class="fw-medium text-white">Arthur</a></span>
      </div>
      <div>
...
<!-- Footer: End -->    
    ...
    <script>
        ...
        for(const [id, valor] of Object.entries(unidades)) {
            ...
            if(numberEl.textContent != valor.toString().padStart(2,'0')) {
